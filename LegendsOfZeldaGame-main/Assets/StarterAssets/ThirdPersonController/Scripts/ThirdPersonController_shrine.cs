...
#endif
    public class ThirdPersonController_shrine : MonoBehaviour
    {
        [Header("Player")]
        ...
        private void Update()
        {
            ...
            JumpAndGravity();
            Move();
            if(_input.rune && RunesAbilities_shrine.bombAbility)
            {
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDBomb = Animator.StringToHash("ThrowBomb");
        }
        ...
        private void RuneAbilities()
        {
                ...
                // bomb
                if (_input.rune  && RunesAbilities_shrine.bombAbility && _bombTimeoutDelta > 0.0f)
                {
